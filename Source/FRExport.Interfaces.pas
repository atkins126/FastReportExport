...
uses
  System.Classes, frxClass, frxDBSet, FireDAC.Comp.Client, FRExport.Types,
...
type
  ...
  IFRExportDataSets = interface
    ...
    function SetDataSet(DataSet: TFDQuery; const FrxDBDatasetUserName: string): IFRExportDataSets; overload;
  ...
  IFRExportExecute = interface
    ...
    function SetFileReport(const FileName: string): IFRExportExecute;
